...
def generate_one(index, palette, title_font, mono_font):
    ...
    lines = [
        [
            ...
            ("analysis_packet=", palette["purple"]),
            ("1 ", palette["base"]),
            ("invite_cipher_packet=", palette["purple"]),
            ("7 ", palette["base"]),
            ("200ok_cipher_packet=", palette["purple"]),
            ("37 ", palette["base"]),
        ],
        [
            ("[2026-03-01 04:43:13,275] [INFO] ", palette["blue"]),
            ("Packet selection ", palette["base"]),
            ("carrier_invite_packet=", palette["pink"]),
            ("7 ", palette["base"]),
            ("carrier_200ok_packet=", palette["pink"]),
            ("37 ", palette["base"]),
            ("core_invite_packet=", palette["pink"]),
            ("12 ", palette["base"]),
            ("core_200ok_packet=", palette["pink"]),
            ("42", palette["base"]),
        ],
        [
            ("[2026-03-01 04:43:13,275] [INFO] ", palette["blue"]),
